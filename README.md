...
1. **Instruction screen**<br>The instruction view presents a number of screens to the app user informering her how to position her face in front of her device. The instruction screen can be deactivated through a parameter to the `SighticInferenceView` init method.
